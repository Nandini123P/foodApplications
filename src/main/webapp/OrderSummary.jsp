...
<body>
    ...
    <div class="container">
        ...
        <form action="CheckoutServlet" method="post">
            ...
            <textarea id="address" name="address" rows="4" required placeholder="Enter your full delivery address"></textarea>

            <label for="phone">Phone Number:</label>
            <input type="text" id="phone" name="phone" required placeholder="Enter your phone number" pattern="[0-9]{10}" title="Enter a valid 10-digit phone number" />
