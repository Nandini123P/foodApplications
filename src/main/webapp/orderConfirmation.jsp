...
.container {
    ...
    gap: 18px;
    margin-top: 80px;
    transition: transform 0.3s ease, box-shadow 0.3s ease; /* Added for smooth effect */
}

.container:hover {
    transform: translateY(-5px);
    box-shadow: 0 16px 30px rgba(30,144,255,0.3);
}
...
.summary-details p {
    ...
    font-size: 1.3rem;  /* Increased font size here too */
}
...
<div style="display: flex; justify-content: center;">
    <div class="summary-details" style="text-align: left;">
        ...
        <div style="display: flex; justify-content: center;">
            <a href="orderConform.jsp" class="confirm-btn" style="width: auto; padding: 15px 40px;">Confirm Order</a>
        </div>
